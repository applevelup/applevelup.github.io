        ...
        var _isDeveloperViewActive = false;

        _evaluateActiveView();

        $('#customerChanger').click(function() {
            _isDeveloperViewActive = !_isDeveloperViewActive;
            _evaluateActiveView();
        });

        function _evaluateActiveView() {
            if (_isDeveloperViewActive) {
                $('#developer').show();
                $('#recruiter').hide();
            } else {
                $('#developer').hide();
